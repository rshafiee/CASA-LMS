...
room_one = Room.create(title: "Akkusativ")
room_one.save
room_two = Room.create(title: "Dative")
room_two.save
room_three = Room.create(title: "The Awful German language")
room_three.save
room_four = Room.create(title: "Stammtisch")
room_four.save
room_three = Room.create(title: "Feirabendbier")
room_three.save
room_four = Room.create(title: "Kopfkino")
room_four.save
